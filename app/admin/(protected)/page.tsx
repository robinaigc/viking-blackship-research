		...
		<main className="mx-auto max-w-7xl px-6 py-12">
			<div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
				<div>
					<p className="text-xs uppercase tracking-[0.2em] text-zinc-600">
						<LocalizedText en="Publishing dashboard" zh="发布管理" />
					</p>
			...
			{params.deleted ? (
				<p className="mt-8 rounded-lg border border-zinc-800 p-4 text-sm text-zinc-300">
					<LocalizedText en="Article deleted." zh="文章已删除。" />
				</p>
			) : null}
			{error ? (
					...
					<div className="divide-y divide-zinc-800">
						{articles.map((article) => (
							<Link
								...
								className="grid gap-3 p-5 hover:bg-zinc-900/70 sm:grid-cols-[1fr_auto_auto] sm:items-center"
							>
								<div>
